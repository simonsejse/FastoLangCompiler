...
# was:	mv	_let_d_24_, _let_b_22_
	li	x11, 1000
# was:	li	_times_L_35_, 1000
# 	mv	_times_R_36_,_let_d_24_
	mul	x11, x11, x12
# was:	mul	_plus_L_33_, _times_L_35_, _times_R_36_
	li	x12, 100
# was:	li	_plus_R_34_, 100
	add	x11, x11, x12
# was:	add	_times_L_31_, _plus_L_33_, _plus_R_34_
	mv	x12, x13
# was:	mv	_times_R_32_, _let_a_21_
	mul	x11, x11, x12
# was:	mul	_plus_L_29_, _times_L_31_, _times_R_32_
	li	x12, 10
# was:	li	_plus_R_30_, 10
	add	x11, x11, x12
# was:	add	_times_L_27_, _plus_L_29_, _plus_R_30_
# 	mv	_times_R_28_,_let_c_23_
	mul	x10, x11, x10
# was:	mul	_plus_L_25_, _times_L_27_, _times_R_28_
